...
local Translations = {
	enUS = {
		...
		GEAR_CHECK_SCAN_UNAVAILABLE = "Unavailable",
		GEAR_CHECK_SCAN_INCOMPLETE = "Incomplete",
	...
	ruRU = {
		...
		GEAR_CHECK_SCAN_UNAVAILABLE = "Недоступно",
		GEAR_CHECK_SCAN_INCOMPLETE = "Неполные данные",
